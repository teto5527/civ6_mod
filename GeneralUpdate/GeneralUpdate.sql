...
--Theology and Military training prereq change to Political philosophy
UPDATE CivicPrereqs SET PrereqCivic = 'CIVIC_POLITICAL_PHILOSOPHY' WHERE Civic = 'CIVIC_THEOLOGY' AND PrereqCivic = 'CIVIC_DRAMA_POETRY';
UPDATE CivicPrereqs SET PrereqCivic = 'CIVIC_POLITICAL_PHILOSOPHY' WHERE Civic = 'CIVIC_MILITARY_TRAINING' AND PrereqCivic = 'CIVIC_GAMES_RECREATION';
...
--Communism buff
UPDATE Policies SET Description = 'LOC_GOVT_INHERENT_BONUS_COMMUNISM_DESCRIPTION_ZJ' WHERE PolicyType = 'POLICY_GOV_COMMUNISM';
...
--Technologies make Spaceport build quicker
UPDATE Technologies SET Description='LOC_TECH_TELECOMMUNICATIONS_DESCRIPTION_ZJ' WHERE TechnologyType='TECH_TELECOMMUNICATIONS';
UPDATE Technologies SET Description='LOC_TECH_NANOTECHNOLOGY_DESCRIPTION_ZJ' WHERE TechnologyType='TECH_NANOTECHNOLOGY';

INSERT INTO TechnologyModifiers (TechnologyType, ModifierId) VALUES 
('TECH_TELECOMMUNICATIONS', 'TELECOMMUNICATIONS_SPACEPORT_PRODUCTION'),
('TECH_NANOTECHNOLOGY', 'NANOTECHNOLOGY_SPACEPORT_PRODUCTION');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('TELECOMMUNICATIONS_SPACEPORT_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 0, 0, 0, NULL, NULL),
('NANOTECHNOLOGY_SPACEPORT_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 0, 0, 0, NULL, NULL);

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('TELECOMMUNICATIONS_SPACEPORT_PRODUCTION', 'Amount', '100'),
('TELECOMMUNICATIONS_SPACEPORT_PRODUCTION', 'DistrictType', 'DISTRICT_SPACEPORT'),
('NANOTECHNOLOGY_SPACEPORT_PRODUCTION', 'Amount', '100'),
('NANOTECHNOLOGY_SPACEPORT_PRODUCTION', 'DistrictType', 'DISTRICT_SPACEPORT');