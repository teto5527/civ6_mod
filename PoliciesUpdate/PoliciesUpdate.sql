...
UPDATE Policies SET Description = 'LOC_POLICY_SPORTS_MEDIA_DESCRIPTION_ZJ' WHERE PolicyType = 'POLICY_SPORTS_MEDIA';
...
UPDATE Policies SET PrereqCivic = 'CIVIC_IDEOLOGY' WHERE PolicyType = 'POLICY_SPORTS_MEDIA';
...
('POLICY_SPORTS_MEDIA', 'PUBLIC_FESTIVAL_ENTERTAINMENT_COMPLEX_GOLD'); --Entertainment Complex +4 Gold
...
('POLICY_SCI_TECH_PROSPERITY', 'SCI_TECH_PROSPERITY_UNIVERSITY_NO_BASE_SCIENCE'), --System can automatically adapts to unique university building types.
