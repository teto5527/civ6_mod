...
INSERT INTO BuildingModifiers (BuildingType, ModifierId) VALUES 
('BUILDING_STATUE_LIBERTY', 'STATUE_LIBERTY_CITY_EXTRA_POPULATION'),
('BUILDING_STATUE_LIBERTY', 'STATUE_LIBERTY_SETTLER_MOVEMENT_BUFF');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('STATUE_LIBERTY_CITY_EXTRA_POPULATION', 'MODIFIER_PLAYER_BUILT_CITIES_GRANT_FREE_POPULATION', 0, 0, 0, NULL, NULL),
('STATUE_LIBERTY_SETTLER_MOVEMENT_BUFF', 'MODIFIER_PLAYER_UNITS_ADJUST_MOVEMENT', 0, 0, 0, NULL, 'REQUIREMENT_UNIT_IS_SETTLER');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('STATUE_LIBERTY_CITY_EXTRA_POPULATION', 'Amount', '2'),
('STATUE_LIBERTY_SETTLER_MOVEMENT_BUFF', 'Amount', '3');
