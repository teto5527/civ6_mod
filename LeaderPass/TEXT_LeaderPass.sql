...
'+200 (becomes +500 after you research Iron Working) [ICON_Gold] Gold whenever you conquer a city for the first time or +100 (becomes +250 after you research Iron Working) [ICON_Gold] Gold when you earn [ICON_Gold] Gold from a Barbarian Outputs.'),
('LOC_ABILITY_CAESAR_GOLD_GOODY_DESCRIPTION',
'Gain 100 Gold when step onto a goody hut.'),
