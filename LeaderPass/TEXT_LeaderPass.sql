...
'+10% [ICON_Production] Production in Cities for every Industrial Zone building in that city. +2 [ICON_Production] Production to all Strategic Resources. Workshop and Factory provide [ICON_Food] Food equal to their intrinsic [ICON_Production] Production output.'),
