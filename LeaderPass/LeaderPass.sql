...
-- ('LEADER_THEODORA', 'TRAIT_LEADER_BUILDING_ROME_MONUMENT');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
-- ('TRAIT_CIVILIZATION_BYZANTIUM','TRAIT_THEODORA_CAPITAL_INCREASED_TILES'),

-- ('TRAIT_LEADER_HWARANG','TRAIT_SEJONG_LIBRARY_GREAT_PERSON_POINT'),
-- ('TRAIT_LEADER_HWARANG','TRAIT_SEJONG_LIBRARY_GREAT_WORK_WRITING_SLOT'),
