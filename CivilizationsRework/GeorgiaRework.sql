...
('POLICY_MILITARY_RESEARCH', 'MILITARYRESEARCH_RENAISSANCE_TSIKHE_SCIENCE_MODIFIER');
...
--Khevsur unlock from Military Tactics
...
('MILITARYRESEARCH_RENAISSANCE_TSIKHE_SCIENCE_MODIFIER', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE', 0, 0, 0, NULL, NULL),
...
('MILITARYRESEARCH_RENAISSANCE_TSIKHE_SCIENCE_MODIFIER', 'BuildingType', 'BUILDING_TSIKHE'),
('MILITARYRESEARCH_RENAISSANCE_TSIKHE_SCIENCE_MODIFIER', 'Amount', '2'),
('MILITARYRESEARCH_RENAISSANCE_TSIKHE_SCIENCE_MODIFIER', 'YieldType', 'YIELD_SCIENCE'),
