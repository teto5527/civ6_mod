...
--Sumeria
UPDATE Traits SET Description = 'LOC_TRAIT_CIVILIZATION_FIRST_CIVILIZATION_DESCRIPTION_ZJ' WHERE TraitType = 'TRAIT_CIVILIZATION_FIRST_CIVILIZATION';

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_FIRST_CIVILIZATION', 'TRAIT_INCREASE_COMBAT_BARBARIAN');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
('TRAIT_INCREASE_COMBAT_BARBARIAN', 'MODIFIER_PLAYER_UNITS_ADJUST_BARBARIAN_COMBAT', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('TRAIT_INCREASE_COMBAT_BARBARIAN', 'Amount', '3');
...
('BUILDING_SUKIENNICE', 'TRAIT_SUKIENNICE_GRANT_TRADER'),
...
('TRAIT_SUKIENNICE_GRANT_TRADER', 'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_CITY', 1, 0, 0, NULL, NULL),
('TRAIT_SUKIENNICE_PRODUCTION_MIRRORS_GOLD', 'MODIFIER_PLAYER_DISTRICT_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('TRAIT_SUKIENNICE_GRANT_TRADER', 'Amount', '1'),
('TRAIT_SUKIENNICE_GRANT_TRADER', 'UnitType', 'UNIT_TRADER'),
