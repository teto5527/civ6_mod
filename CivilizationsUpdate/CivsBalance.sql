...
UPDATE ModifierArguments SET Value = 3 WHERE ModifierId = 'TRAIT_SCIENTIST_ECSTATIC' AND Name = 'Amount';
UPDATE ModifierArguments SET Value = 3 WHERE ModifierId = 'TRAIT_ENGINEER_ECSTATIC' AND Name = 'Amount';
