...
INSERT INTO TraitModifiers(TraitType, ModifierId) VALUES 
('TRAIT_CIVILIZATION_CREE_TRADE_GAIN_TILES', 'TRAIT_GRANT_RELIC');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('TRAIT_GRANT_RELIC', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 0, 0, 0, NULL, NULL),
('TRAIT_GRANT_RELIC_MOD', 'MODIFIER_PLAYER_GRANT_RELIC', 1, 1, 0, NULL, 'BUILDING_IS_PALACE');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
('TRAIT_GRANT_RELIC', 'ModifierId', 'TRAIT_GRANT_RELIC_MOD'),
('TRAIT_GRANT_RELIC_MOD', 'Amount', '1');
