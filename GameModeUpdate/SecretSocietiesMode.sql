...
--Hermetic Order 
--lv1: every Ley Line in city +5% all yield
-- UPDATE GovernorPromotions
--     SET Description='LOC_GOVERNOR_PROMOTION_HERMETIC_ORDER_1_ZJ'
--     WHERE GovernorPromotionType='GOVERNOR_PROMOTION_HERMETIC_ORDER_1';
-- INSERT OR REPLACE INTO GameModifiers (ModifierId) VALUES
-- ('GOVERNOR_PROMOTION_HERMETIC_ORDER_1_CITY_PER_LEY_LINE_YIELD');
-- INSERT OR REPLACE INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES 
-- ('GOVERNOR_PROMOTION_HERMETIC_ORDER_1', 'GOVERNOR_PROMOTION_HERMETIC_ORDER_1_CITY_PER_LEY_LINE_YIELD');
-- INSERT OR REPLACE INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES 
...
-- ('GOVERNOR_PROMOTION_OWLS_OF_MINERVA_1_PER_TRIBUTARY_GOLD', 'Amount', '5');
